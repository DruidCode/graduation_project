...
define('API_FUNC_PRE',                 "api_www_");
define('AUTH_KEY',						'a14%xubEd#s%sdA$');

define('FROM_SIGN_FLAG',				'sign');

//define('API_WWW_HOST',					'http://capi.zhisland.com/web');       //测试
define('API_WWW_HOST',					'http://denglianwen.api.deving.zhisland.com/web');       //测试
...
function tidy_resp($resp){
   	if($resp['status_code'] == 0){
	    return array("code" => $resp['status_code'],"data"=>$resp['data']);
	}else{
