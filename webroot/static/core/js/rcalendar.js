...
function rcalendar(text, mode, retfunction) { //文本域对象, 模式(dateonly,full), 选择日期后的事件函数(函数是新时间的Date对象)
	...
	if (!div_rcalendar) { //如果不存在，则初始化创建它
		...
		if (document.compatMode == "BackCompat" && navigator.userAgent.indexOf("MSIE") != -1) {
			...
			css += "#rcalendar_ym {width:190px; height:14px;line-height:14px; overflow:hidden; margin:6px 0;}";
			css += "#rcalendar_y {width:48px; float:left; font-weight:bold; color:#777777; padding-left:2px;}";
			css += "#rcalendar_m {width:50px; float:left; font-weight:bold; color:#777777;}";
			css += "#rweeks {width:190px; height:20px; overflow:hidden;}";
			css += "#rdates {width:190px; height:120px; overflow:hidden;}";
			css += ".rweek {width:27px; height:12px;line-height:12px; padding:4px 0px 4px 0px; float:left; text-align:center; background:#CCCCCC; color:#FFFFFF; overflow:hidden;}";
			css += ".rdate {width:27px; height:12px;line-height:12px; padding:4px 0px 4px 0px; float:left; text-align:center; overflow:hidden; cursor:pointer;}";
			css += "#ryears {background:#B0B0B0; border:1px solid #999999; border-top:0px; color:#FFFFFF; text-align:center;}";
			css += ".ryear {padding:4px 4px 4px 4px; height:12px;line-height: 12px; width:28px; overflow:hidden; cursor:pointer; font-weight:bold;}";
			css += "#ryear_add {padding:0px; height:12px;line-height:12px; width:36px; overflow:hidden; cursor:pointer;}";
			...
			css += ".rmonth {padding:4px 4px 4px 4px; width:18px; height:12px;line-height:12px; overflow:hidden; float:left; cursor:pointer;}";
			css += "#rtime {width:90px; height:13px; float:left; overflow:hidden;}";
			css += "#rhour {padding:0px 7px 0px 7px; background:#E9E9E9; cursor:pointer;}";
			css += "#rminute {padding:0px 7px 0px 7px; background:#E9E9E9; cursor:pointer;}";
			css += "#rsecond {padding:0px 7px 0px 7px; background:#E9E9E9; cursor:pointer;}";
			css += "#rbtns {width:90px; margin-left:10px; height:20px;line-height:20px; float:right; text-align:right; overflow:hidden;}";
			css += "#rhours {width:104px; height:108px; overflow:hidden;}";
			...
			css += "#rainic {width:184px; height:0; padding:0px 3px 0px 3px; overflow:hidden; text-align:right; background:#E0E0E0; margin-top:4px;}";
			css += "#rainic a, #rainic a:visited, #rainic a:hover {font-size:9px;font-family:Arial; color:#FFFFFF; text-decoration:none;}";
		}
		try { //IE下可行
		...
		str += '<div style="width:190px; height:20px; line-height:20px; margin-top:4px; overflow:hidden;">';
		str += '  <div id="rtime">';
